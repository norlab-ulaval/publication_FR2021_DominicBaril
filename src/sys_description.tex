...
By logging all robot poses, we build a reference trajectory $\bm x_{\text{2D}}$.
...
During the repeat phase, the path map is loaded and used directly as the reference point cloud $\refpc$.
