...
Subsequently, the repeat phase is described, when the robot localizes within the map a simple controller allows to compute commands that allow to repeat the reference trajectory.
...
Thirdly, a robot frame $\robotf$ is defined with it's origin at the base of the robot chassis and the $x$-axis parallel to the longitudinal direction and the $y$-axis parallel to the lateral direction of the vehicle.
